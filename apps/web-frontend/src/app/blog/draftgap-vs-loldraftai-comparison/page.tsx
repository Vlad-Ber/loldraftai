    ...
    <main className="flex min-h-screen w-full flex-col items-center bg-background text-foreground">
      ...
      <div className="w-full bg-gradient-to-b from-primary/10 to-background py-8">
        <div className="container flex flex-col items-center justify-center gap-4 px-4">
          <h1 className="text-4xl font-bold tracking-tight text-primary text-center">
            DraftGap vs <span className="brand-text">LoLDraftAI</span>: A
            Detailed Comparison
          </h1>
      ...
      <article className="container px-4 py-12 prose prose-invert max-w-3xl">
        <p>
          ...
          <span className="brand-text">LoLDraftAI</span> consistently
          outperforms DraftGap in prediction accuracy (65.6% vs 56.5% on unseen
          data), thanks to its more sophisticated understanding of league
          dynamics. This article breaks down the key differences that make{" "}
        ...
        <div className="note border border-secondary/30">
          <p className="text-sm">
            ...
            overall team comp identity is not taken into account. The synergy of
        ...
        <p>
          ...
          some examples of when the statistical approach of DraftGap falls
          short.
        </p>
        ...
        <p>
          ...
          match id. Example verification for the first match of the dataset:
          Match results:{" "}
