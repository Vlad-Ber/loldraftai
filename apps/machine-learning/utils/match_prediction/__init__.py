...
PRO_MODEL_PATH = os.path.join(MODEL_DIR, "match_outcome_model_pro_finetuned.pth")
ONNX_MODEL_PATH = os.path.join(MODEL_DIR, "match_outcome_model.onnx")
PRO_ONNX_MODEL_PATH = os.path.join(MODEL_DIR, "match_outcome_model_pro_finetuned.onnx")
